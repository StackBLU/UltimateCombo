...
internal static class Eureka
{
    ...
    internal class Eureka_Wisdoms : CustomComboBase
    {
    ...
    internal class Eureka_Offensive : CustomComboBase
    {
        ...
        protected override uint Invoke(uint actionID, uint lastComboMove)
        {
            ...
            {
                if (IsEnabled(Presets.Eureka_Bloodbath) && DutyActionReady(Bloodbath) && DutyActionEquipped(Bloodbath))
                {
                    return Bloodbath;
                }

                if (IsEnabled(Presets.Eureka_MagicBurst) && DutyActionReady(MagicBurst) && DutyActionEquipped(MagicBurst))
                {
                    return MagicBurst;
                }

                if (IsEnabled(Presets.Eureka_DoubleEdge) && DutyActionReady(DoubleEdge) && DutyActionEquipped(DoubleEdge))
                {
                    return DoubleEdge;
                }

                if (IsEnabled(Presets.Eureka_EagleEyeShot) && DutyActionReady(EagleEyeShot) && DutyActionEquipped(EagleEyeShot))
                {
                    return EagleEyeShot;
                }
            }
    ...
    internal class Eureka_Curative : CustomComboBase
    {
    ...
    internal class Eureka_Tactical : CustomComboBase
    {
        ...
        protected override uint Invoke(uint actionID, uint lastComboMove)
        {
            ...
            {
                if (IsEnabled(Presets.Eureka_Swift) && DutyActionReady(Swift) && DutyActionEquipped(Swift))
                {
                    return Swift;
                }

                if (IsEnabled(Presets.Eureka_Featherfoot) && DutyActionReady(Featherfoot) && DutyActionEquipped(Featherfoot))
                {
                    return Featherfoot;
                }

                if (IsEnabled(Presets.Eureka_Feint) && DutyActionReady(Feint) && DutyActionEquipped(Feint))
                {
                    return Feint;
                }
            }
    ...
    internal class Eureka_Inimical : CustomComboBase
    {
        ...
        protected override uint Invoke(uint actionID, uint lastComboMove)
        {
            ...
            {
                if (IsEnabled(Presets.Eureka_Paralyze) && DutyActionReady(Paralyze) && DutyActionEquipped(Paralyze))
                {
                    return Paralyze;
                }

                if (IsEnabled(Presets.Eureka_SpiritDart) && DutyActionReady(SpiritDart) && DutyActionEquipped(SpiritDart))
                {
                    return SpiritDart;
                }

                if (IsEnabled(Presets.Eureka_Tranquilizer) && DutyActionReady(Tranquilizer) && DutyActionEquipped(Tranquilizer))
                {
                    return Tranquilizer;
                }
            }
    ...
    internal class Eureka_Mitigative : CustomComboBase
    {
        ...
        protected override uint Invoke(uint actionID, uint lastComboMove)
        {
            ...
            {
                if (IsEnabled(Presets.Eureka_Protect) && DutyActionReady(Protect) && DutyActionEquipped(Protect))
                {
                    return Protect;
                }

                if (IsEnabled(Presets.Eureka_Shell) && DutyActionReady(Shell) && DutyActionEquipped(Shell))
                {
                    return Shell;
                }

                if (IsEnabled(Presets.Eureka_Stoneskin) && DutyActionReady(Stoneskin) && DutyActionEquipped(Stoneskin))
                {
                    return Stoneskin;
                }
            }
