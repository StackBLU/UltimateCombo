...
namespace UltimateCombo.ComboHelper.Functions
{
    ...
    public class UserIntArray(string v) : UserData(v)
    {
        ...
        public int Count => PluginConfiguration.GetCustomIntArrayValue(pName).Length;
        ...
        public int[] Items => PluginConfiguration.GetCustomIntArrayValue(pName);
        ...
        {
            var array = PluginConfiguration.GetCustomIntArrayValue(pName);
    ...
    internal class UserBoolArray(string v) : UserData(v)
    {
        ...
        public bool this[int index]
        {
            get
            {
                if (index >= Count)
                {
                    var array = PluginConfiguration.GetCustomBoolArrayValue(pName);
                    Array.Resize(ref array, index + 1);
                    array[index] = false;
